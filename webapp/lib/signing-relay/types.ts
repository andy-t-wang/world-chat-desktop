...
// Signing request timeout (50 minutes - XMTP may need multiple signatures)
export const SIGN_TIMEOUT_MS = 3000000;

// Auth challenge timeout (5 minutes)
export const AUTH_TIMEOUT_MS = 300000;
